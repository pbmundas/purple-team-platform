...
The Docker lab publishes Wazuh agent traffic on **15140/TCP** and enrollment on **15150/TCP**. A pre-existing Ubuntu agent configured for Wazuh's defaults (1514/1515) will show as disconnected. The included Docker Ubuntu victim uses the internal `wazuh.manager` DNS name and ports 1514/1515; do not point it at a hard-coded container IP.
